...
const inputClass = 'h-12 border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#17120f] outline-none transition placeholder:text-[#806f65] focus:border-[#17120f] focus:bg-white'
